...
document.querySelectorAll('.button').forEach(button => {
  ...
  const item = document.querySelector("section:nth-of-type(2)");
  ...
  const openButton = document.querySelector('section:nth-of-type(2) article:nth-of-type(1) button');
  const closebutton = document.querySelector('section:nth-of-type(3) button');
const sectionHead = document.querySelector('section:nth-of-type(3)');

openButton.addEventListener('click', () => { 
  console.log('clicked');
  sectionHead.classList.add('comeback');
});

closebutton.addEventListener('click', () => { 
  console.log('clicked');
  sectionHead.classList.toggle('comeback');
});
